...
<div class="menu-user">
    <div class="mu-userinfo">
        <div class="avatar">
            <a href="/thanh-vien/doi-avatar.html"><img style="border: 0px;  " src="<? echo show_img(str_replace('upload/images/avatar/','',$user_info['Avatar']),$thumb='400x250','/upload/images/avatar/');?>" /></a>
        </div>
      ...
      ?>
        ...
        echo '<span style=" float: right; text-align: right;">Chưa kích hoạt</span>';
      }else{echo '<span style="font-weight: bold;float: right; text-align: right;">Đã kích hoạt</span>';}?>
            </span>
    ...
    <ul>
     ...
     <?
        $Tabs=array('Quản lý tài khoản'=>array(
                                          'Sửa thông tin cá nhân'=>'thanh-vien/sua-thong-tin-ca-nhan.html',
        ...
        foreach($Tabs as $name=>$link){
            ...
            if(is_array($link)){
              echo "
              <li class='lead'><a href='javascript:'>$name</a></li> 
              ";
              ...
              echo "
               <li class='$actived'><a href='/$link'>$name</a></li>
              ";
            }
        }
        ?>    
