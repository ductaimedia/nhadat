      ...
      <p><span class="promotion-acc">
                ...
                <b>
                     <? echo $Loai;?>
                                        ...
                                        <div class="uprofile-info" style="padding: 10px;">
                                        ...
                                        <div class="uprofile-buttons">
                                            ...
                                            <a class="btn btn-md btn-primary <? if($_GET['act']==2){echo 'active';} ?>" href="/thanhvien/xemthanhvien/<? echo $info_user['userid'];?>?region=9-1&act=2">Xem tất cả tin rao đã đăng</a>
                                        </div>
