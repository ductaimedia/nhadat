                  ...
                  <td><div class="btn-group    ">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                                ...
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.base_url().'thanhvien/chucvu/'.$member['userid'].'">Loại tài khoản</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.base_url().'thanhvien/money/'.$member['userid'].'">Nạp tiền vào tài khoản</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.base_url().'thanhvien/khoanick/'.$member['userid'].'">Khóa/mở tài khoản</a></li>
                                            </ul>
                                        </div>
                                    </div></td> 
                  <td><div class="btn-group    ">
                                        <div class="dropdown">
                                            <button class="btn btn-primary dropdown-toggle btn-sm" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="false">
                                                Xem

                                                <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="/thanhvien/xemthanhvien/'.$member['userid'].'?region=9-1&act=1">Xem lịch sử truy cập</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="/thanhvien/xemthanhvien/'.$member['userid'].'?region=9-1&act=2">Xem tất cả tin rao đã đăng</a></li> 
                                            </ul>
                                        </div>
                                    </div></td> 
