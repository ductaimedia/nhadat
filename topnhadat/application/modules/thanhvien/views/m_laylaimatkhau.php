...
<div style="color: red;padding-top: 10px;"><?php $this->load->view('template/statut_thongbao');?></div>
    <div id="boxLogin">
        <div class="item">
            ...
            <input name="password" type="password" id="txtUserName" class="textbox" autocomplete="off" />
        </div> 
        <div class="item">
            <div class="text"><?php echo $this->lang->line('lable_NhapLaiMatKhauMoi');?> <span>*</span></div>
            <input name="repassword" type="password" id="txtUserName" class="textbox" autocomplete="off" />
        </div>
