                        ...
                        <section class="box ">
                            ...
                            <?php
                               if($users['LoGo']!=''){
                                ...
                                echo '<img src="'.$users['LoGo'].'" width="175" height="115" style="max-width: 100px;max-height: 100px;">
                            ';
                            }
                            ?>
...
<script src="/style/js/GoogleMapControl.min.js?v=20151126" type="text/javascript"></script>
<div id="mapinfo">
