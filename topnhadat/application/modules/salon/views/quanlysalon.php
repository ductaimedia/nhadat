...
<?php $this->load->view("admin/statut_thongbao");?>
        ...
        { 
            ...
            echo '<tr>
                  ...
                  <td style="width:20px"><a target="_blank" href="/'.stripUnicode($member['TenSalon']).'-pj'.$member['IDSalon'].'.html" ><img src="'.get_first_img($member['LoGo']).'" style="width:40px;height:40px" alt=""></a></td>
