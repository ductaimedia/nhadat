...
<? include APPPATH.'modules/lienhe/views/left_tab.php'; ?>
                                        ...
                                        <div class="mail_content">
                                            ...
                                            <div class="row" style="margin-bottom: 10px;">
                                                <div class="col-md-7 col-sm-7 col-xs-7">
                                                    ...
                                                    <h3 class="mail_head"><?php echo $this->lang->line('title_quanlylienhe');?> <sup><?php echo ($totalrow!=''||$totalrow!=0?"($totalrow)":'');?></sup></h3>
        ...
        { 
            ...
            echo ' <tr class="unread" data-id="'.$member['IDBaiViet'].'">
                                                            ...
                                                            <td style="width:20px"><a href="javascript://" class="btn btn-danger btn-sm" onclick="Delete('.$member['IDBaiViet'].');"><i class="fa fa-trash-o"></i> Xóa</a></td>   
                                                        </tr> 
            ';
        }
        }else{
