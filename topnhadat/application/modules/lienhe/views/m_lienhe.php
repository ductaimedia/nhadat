...
<div id="boxContact">
    <h1 class="tit"><span class="content-tit">Liên hệ</span></h1>
    ...
    <div class="listbox">
        ...
        <div class="item">
            ...
            <textarea name="message" rows="2" cols="20" id="txtContent" class="txtContent textbox"><?php echo set_value('message');?>
</textarea>
        </div>
        <div class="item">
            <div class="lable">
            ...
            <input name="MaXacNhan" type="text" id="txtcode" class="txtcode textbox" />
        ...
        <div class="item">
            <div class="item-btn">
                <a id="btContact" onclick="document.getElementById('adminForm2').submit();" class="button" style="cursor: pointer;">Gửi</a>
            </div>
        </div>
    </div>
