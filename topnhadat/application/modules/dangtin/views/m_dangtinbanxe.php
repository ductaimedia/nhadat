...
$(document).ready(function () { 
    ...
    <div class="content_default">
        <div id="MainContent_postHeader">
            ...
            <div style="padding: 10px;padding-bottom: 15px; "><?php $this->load->view('template/statut_thongbao');?></div>
            <div class="sale">
                <div id="typeSell">
                ...
                <div id="typeSang">
                    <div id="hplSang" class="sale_tab sang" onclick="getDoiXe(747);$('.sale_tab').removeClass('active');$(this).addClass('active');">
                        Sang nhượng
                    </div>
                </div>
            </div>
...
<label style="width: 270px!important;color: red;"><input type="radio" name="TrangThai" value="0" <?php if($tinban['TrangThai']==0){echo 'checked';} ?> /> <?php echo $this->lang->line('lable_ChuaKichHoat');?></label>
                ...
                <div class="item width_100">
                    <div class="text">
                        ...
                        <select name="HangXe" id="ddlCatePost" class="select">
		<option value="">-- Loại nh&#224; đất --</option>
	</select>  
                </div>
                <div class="item padding_right">
                    <div class="text">
                        Tỉnh/Thành phố <span>*</span>
                    </div>  
                       <select id="ddlCity" name="DoiXe" class="select-menu select">
...
?>
                ...
                <div class="item">
                    ...
                    <select name="NamSX" id="ddlDistrict" class="select">
                ...
                <div class="item padding_right">
                    ...
                    <select name="XuatXu" id="ddlWard" class="select">
                ...
                <div class="item">
                    <div class="text">
                        ...
                        <select name="PhanHang" id="ddlStreets" class="select" >
                ...
                <div class="item padding_right">
                    ...
                    <select id="ddlProjects" name="TinhTrang" class="select">
                ...
                <div class="item">
                    ...
                    <input name="NgoaiThat" type="text" maxlength="10" id="txtDientich" class="textbox w95pt numbersOnly" onchange="ChangeDientich(this)" value="<? if($tinban['NgoaiThat']!=''){echo $tinban['NgoaiThat'];}else{echo set_value('NgoaiThat');};?>"/>
                ...
                <div class="item padding_right">
                    ...
                    <input name="GiaTien" type="text" maxlength="10" id="txtGia" class="textbox numbersOnly" onchange="ChangeMucgia(this)" value="<? if($tinban['GiaTien']!=''){echo $tinban['GiaTien'];}else{echo set_value('GiaTien');};?>"/>
                    <span class="error" id="spanGia">Giá không hợp lệ!</span>
                </div>
                <div class="item">
                    <div class="text">Đơn vị</div> 
                        <select id="SoKM" name="SoKM" class="select">
                ...
                <div class="item width_100">
                    ...
                    <input name="DongXe" value="<? if($tinban['DongXe']!=''){echo $tinban['DongXe'];}else{echo set_value('DongXe');};?>" type="text" maxlength="150" id="txtDiadiem" class="w95pt" onchange="ChangeDiadiem(this)" />
        ...
        <div class="box">
            ...
            <div class="listbox">
                <div class="item padding_right">
                    ...
                    <input name="HopSo" value="<? if($tinban['HopSo']!=''){echo $tinban['HopSo'];}else{echo set_value('HopSo');};?>" type="text" maxlength="10" id="txtMattien" class="textbox numbersOnly" />
                ...
                <div class="item">
                    ...
                    <input name="DanDong" value="<? if($tinban['DanDong']!=''){echo $tinban['DanDong'];}else{echo set_value('DanDong');};?>" type="text" maxlength="10" id="txtDuongtruocnha" class="textbox w95pt numbersOnly" placeholder="m" /> 
                </div>
                <div class="item padding_right">
                    <div class="text">
                        Hướng BĐS
                    </div>  
                        <select name="NoiThat" class="select-item select">
                ...
                <div class="item">
                    ...
                    <input name="NhienLieu" value="<? if($tinban['NhienLieu']!=''){echo $tinban['NhienLieu'];}else{echo set_value('NhienLieu');};?>" type="text" maxlength="3" id="txtSotang" class="textbox w95pt numbersOnly" />
                ...
                <div class="item padding_right">
                    ...
                    <input name="HeThongNapNhienLieu" value="<? if($tinban['HeThongNapNhienLieu']!=''){echo $tinban['HeThongNapNhienLieu'];}else{echo set_value('HeThongNapNhienLieu');};?>" type="text" maxlength="3" id="txtSophong" class="textbox numbersOnly" />
                ...
                <div class="item">
                    ...
                    <input name="MucTieuThu" value="<? if($tinban['MucTieuThu']!=''){echo $tinban['MucTieuThu'];}else{echo set_value('MucTieuThu');};?>" type="text" maxlength="3" id="txtSotoilet" class="textbox w95pt numbersOnly" />
        ...
        <div class="box">
            ...
            <div class="listbox">
                <div class="item width_100">
                    ...
                    <input name="TieuDe" value="<? if($tinban['TieuDe']!=''){echo $tinban['TieuDe'];}else{echo set_value('TieuDe');};?>" type="text" maxlength="150" id="txtTieude" class="w95pt" />
                </div> 
                <div class="item width_100">
                    <div class="text">
        ...
        <div class="box">
            ...
            <div class="listbox">
                <div class="item width_100">
                    ...
                    <input  <? echo $dissabled;?> <?  if(isset($data_user_info)||$this->session->userdata('userid')==FALSE){?> name="contact[HoVaTen]" <?}?> type="text" value="<?  if(isset($data_user_info)){echo $data_user_info['HoVaTen'];}elseif(isset($user_info)){echo $user_info['HoVaTen'];}else{echo $_POST['contact']['HoVaTen'];};?>" maxlength="100" id="txtHovaten" class="textbox w95pt" />
                </div>
                <div class="item width_100">
                    <div class="text">
                        Địa chỉ
                    </div>
                    <input <? echo $dissabled;?> <?  if(isset($data_user_info)||$this->session->userdata('userid')==FALSE){?>name="contact[DiaChi]"<?}?> type="text" value="<?  if(isset($data_user_info)){echo $data_user_info['DiaChi'];}elseif(isset($user_info)){echo $user_info['DiaChi'];}else{echo $_POST['contact']['DiaChi'];};?>" maxlength="150" id="MainContent_PostNewsMobile_txtDiachi" class="textbox w95pt" />
                </div>
                <div class="item width_100">
                    <div class="text">
                        Điện thoại  <span>*</span>
                    </div>
                    <input  <? echo $dissabled;?> <?  if(isset($data_user_info)||$this->session->userdata('userid')==FALSE){?>name="contact[DienThoai]"<?}?> type="text" value="<?  if(isset($data_user_info)){echo $data_user_info['DienThoai'];}elseif(isset($user_info)){echo $user_info['DienThoai'];}else{echo $_POST['contact']['DienThoai'];};?>" id="txtDienthoai" class="textbox w95pt" />
                </div> 
                <div class="item width_100">
                    <div class="text">
                        Email <span class="error" id="spanEmail">Email sai định dạng, bạn hãy nhập lại!</span>
                    </div>
                    <input <? echo $dissabled;?> <?  if(isset($data_user_info)||$this->session->userdata('userid')==FALSE){?>name="contact[Email]"<?}?> type="text" value="<?  if(isset($data_user_info)){echo $data_user_info['Email'];}elseif(isset($user_info)){echo $user_info['Email'];}else{echo $_POST['contact']['Email'];};?>" maxlength="50" id="txtEmail" class="textbox w95pt" />
                </div>
...
<?
            if($tinban==''):?>
            <div id="MainContent_PostNewsMobile_divCaptcha" class="item padding_right">
                <div class="text">
                    Mã an toàn <span>*</span>
                </div>
                <input name="MaXacNhan" type="text" maxlength="10" class="textbox "/>
            ...
            <div class="item wr_botton">
                <a onclick="return ValidateData();" id="btnSave" class="button" href="javascript:document.getElementById('frmAuto').submit()"><?
            if($tinban==''){echo 'Đăng tin';}else{echo 'Lưu tin';}?> </a>
                <a id="MainContent_PostNewsMobile_btnCancel" class="button button2" href="/thanh-vien/quan-ly-tin-rao">Hủy</a>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var productid = '0';
    var RootDomain = 'https://batdongsantop10.net';   
