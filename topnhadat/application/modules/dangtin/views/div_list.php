...
$xe_view='pr';
                  ...
                  <? 
                    ...
                    ?>
	 					 <li>
                    <a href="<? echo $link;?>"><img id="ContentPlaceHolder1_ProductSearchResult1_rpProductList_imgAvatar_0" title="<? echo $tintuc['TieuDe'];?>" width="140" height="104" src="<?php echo get_first_img($tintuc['AlbumAnh']);?>" alt="<? echo $tintuc['TieuDe'];?>" /></a>
                    <div class="desc">
                        <h4>
                            <a class="<? echo $divType;?>" title="<? echo $tintuc['TieuDe'];?>" href="<? echo $link;?>"><? echo $tintuc['TieuDe'];?></a></h4>
                        <div class="other">
                            ...
                            <div class="area"><label>Diện tích<span>:</span></label>
                                <? echo $tintuc['NgoaiThat'];?> m²</div>
                            <div class="location"><label>Vị trí<span>:</span></label>
                                <? echo $tintuc['NamSX'];?> - <? echo $tintuc['DoiXe'];?></div>
                        </div>
                        <span class="date">
