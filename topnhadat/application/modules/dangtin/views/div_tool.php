<!--<div class="utility">
    ...
    <div class="utility-content">
        <ul>
            <li class="email"><a rel="nofollow" href="javascript:" id="UtilityRegisterEmail" class="fancybox.ajax">Nhận tin bđs qua email</a></li>
            ...
            <li class="vanban <? //if($this->uri->segment(1)=='van-ban-nganh-xay-dung'){echo 'act';} ?>"><a  rel="nofollow" href="/van-ban-nganh-xay-dung">Văn bản ngành xây dựng</a></li>
        </ul>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>-->
