...
<div class="shadowbox" style="overflow: hidden;margin-top: 5px;padding-bottom: 7px;width:520px"> 
                        <style>
                        .upload-item{
                        ...
                        <div class="uploadimg" style="display: block;height: 80px;  float: right;">
                        <p style="color: #222; text-transform: none;font: italic 13px 'Open Sans';<? if(isset($hidden)){echo'display:none';} ?>">(Vui lòng không chèn thêm link của bất kỳ website nào khác)</p>
                            <p style="<? if(isset($hidden)){echo'display:none';} ?>">Đăng ảnh theo các định dạng: jpg, png... (Chỉ up được mỗi lần 1 tấm)</p>
                ...
                <div class="note note-success" id='succes' style='display: none;font-weight: bold; padding: 10px;padding-top: 5px;padding-bottom: 5px;margin-top: 4px;width: 100%;margin-left: 0px;'><i class="mpx-checked"></i> Tải ảnh thành công</div>
                        ...
                        <div id="image_lists" style="display: block;margin-top: 110px;<? if(isset($hidden)){echo'width:340px!important';} ?>"> 	 
			                <?php
