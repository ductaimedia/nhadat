...
?>
                ...
                <select id="ddlProjects" name="TinhTrang" class="bs-item1" >
                        ...
                        <div class="bs-action">
                            ...
                            <div class="bs-search">
                                 <a class="btnsearch" onclick="autoSearch()" href="javascript://"><img src="/style/images/btnSearch.png" /></a>
...
<?
                                    ...
                                    if($quan!=''||$this->session->userdata('DoiXe')){  
                                         echo "<script>GetArea('GetDistrict','cityCode',$('#ddlCity').find('option:selected').attr('data-key'),'ddlDistrict','Quận/Huyện','$quan');</script>";
                                    } 
                                    ?>
            <?
...
<script type="text/javascript">
    ...
    $('#ddlDistrict').on('change', function () { 
        ...
        GetArea('GetStreet','distId',$('option:selected', this).attr('data-key'),'ddlStreets','Đường/Phố','<? echo $duong;?>');        GetArea('GetProject','distId',$('option:selected', this).attr('data-key'),'ddlProjects','-- Chọn Dự án --','<? echo $duan;?>'); 
    }); 
