...
<div class="menuleft">
    <div class="div_logo">
        <a href="/" class="a_logo">
            <img title="Đô thị" alt="Đô thị" src="/admincp/themes/ultra-admin-2.1/assets/images/logo.png">
        </a>
    ...
    <ul class="content-menu">
        <? if($this->session->userdata('userid')==FALSE):?>
                        <li><a href="/thanh-vien/dang-nhap.html" class="item">Đăng nhập/ Đăng ký</a></li>
                <? else:?>
                <li><a href="/trang-ca-nhan" rel="nofollow" id="dangnhap" title="<? echo $user_info['username'];?>"><span>Chào </span>, <b style="color: yellow;"><? echo $user_info['username'];?></b></a></li>
                <? endif?>
        
        
        <li><a href="/nha-dat-ban" class="item">Bất động sản bán</a></li>
        <li><a href="/nha-dat-cho-thue" class="item">Bất động sản cho thuê</a></li>
        <li><a href="/dang-tin-ban-cho-thue-nha-dat" class="item">Đăng tin</a></li>
        <? if($this->session->userdata('userid')==FALSE):?>
                         
                <? else:?>
               <li><a href="/thanh-vien/quan-ly-tin-rao" class="item">Quản lý tin rao
            </a></li>
                <? endif?>
        ...
        <li><a href="/gioi-thieu" class="item">Giới thiệu chung</a></li>
        ...
        <div class="content-page">
            <div class="page-body">
                <div class="kheader" onclick="CloseShareListing();">
                    <div class="div_logo">
                        <a href="/">
                            <img src="/admincp/themes/ultra-admin-2.1/assets/images/logo.png" alt="Đô thị" title="Đô thị" />
                        </a>
                    </div>
                    <div class="div_logo2">
                        <div class="div_menu" id="div_menu">
                            <a href="javascript:showMenu();" rel="nofollow">
                                <img src="/style/mobile/images/menu.png" /></a>
                        </div>
