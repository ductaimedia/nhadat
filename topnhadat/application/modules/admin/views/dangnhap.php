        ...
        <div class="login-wrapper">
            <div id="login" class="login loginpage col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-2 col-xs-8">
                ...
                <form name="loginform" id="loginform" action="" method="post"> 
                    <p>
                        <label for="user_login"><?php echo $this->lang->line('lable_username');?><br />
                            <input type="text" name="username" id="user_login" class="input"  /></label>
                    </p>
                    <p>
                        <label for="user_pass"><?php echo $this->lang->line('lable_password');?><br />
                ...
                <p id="nav">
                    ...
                    <a class="pull-right" href="/thanh-vien/dang-ky.html" title="Đăng ký">Đăng ký !</a>
                </p>
