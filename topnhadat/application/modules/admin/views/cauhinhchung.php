...
<?php
                   ...
                   ?>
                        ...
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Thông tin hỗ trợ</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i> 
                                    <i class="box_close fa fa-times"></i>
                                </div>
                            ...
                            <div class="content-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="Yahoo">Yahoo</label> 
                                            <div class="controls">
                                                <input type="text" class="form-control input-lg"  id="Yahoo" name="Yahoo" value="<?php echo $data->{'Yahoo'};?>"/>
                                            </div>
                                        </div> 
