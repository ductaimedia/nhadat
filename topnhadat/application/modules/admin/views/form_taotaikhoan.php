...
<?php $this->load->view("admin/statut_thongbao");?>
                        ...
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left"><?php echo $this->lang->line('title_creat_acc');?> <b style="color: blue;"><? echo $username;?></b>:</h2>
                            ...
                            <div class="content-body">
                                <div class="row"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="password"><?php echo $this->lang->line('lable_ChucVu');?> </label> 
                                            <div class="controls">
             ...
             <option value="2" <?php set_select('ChucVu', '2'); ?> ><?php echo $this->lang->line('lable_Mod');?></option>
